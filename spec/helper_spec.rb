...
describe 'Helper module' do
  ...
  describe 'get_shift_diff method' do
    it 'returns the correct total distance to shift including overflow' do
      expect(Helper.get_shift_diff(3, 10)).to eq(3)
      expect(Helper.get_shift_diff(21, 57000)).to eq(21)
      expect(Helper.get_shift_diff(55, 10)).to eq(5)
      expect(Helper.get_shift_diff(5541, 23)).to eq(21)
      expect(Helper.get_shift_diff(-96, 64871)).to eq(-96)
      expect(Helper.get_shift_diff(-5541, 23)).to eq(-21)
      expect(Helper.get_shift_diff(0, 54)).to eq(0)
    end
  end
